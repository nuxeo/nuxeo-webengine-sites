...
/**
 * Action fragment for initializing the fragment related to the list with the details about the <b>Tag</b>-s that have
 * been created under a web page, in the fragment initialization mechanism.
 */
public class TagFragment extends AbstractFragment {

    /**
     * Returns the list with the details about the <b>Tag</b>-s that have been created under a web page.
     */
    @Override
    public Model getModel() throws ModelException {
        ...
        try {
            ...
            List<Tag> tags = tagService.getDocumentTags(session, documentModel.getId(), null);
